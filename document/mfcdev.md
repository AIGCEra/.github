...
## (2)AppBase: Replace CWinApp(Ex) with CWebRTApp(Ex), This step is required for all types of MFC desktop applications
...
## (4)Tabbed MDI Application Message Loop: Replace CMDIFrameWndEx with CWebRTMDIFrame
