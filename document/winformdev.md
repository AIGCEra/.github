...
## (1)AppBase: Replace CWinApp(Ex) with CWebRTApp(Ex), This step is required for all types of MFC desktop applications
...
## (2)Tabbed MDI Application: Replace CMDIFrameWndEx with CWebRTMDIFrame
![](https://)
...
## (3)Preparation: This step is required for all types of WinForm Desktop Applications
