...
<p>  
每一个“窗口核”（<i><ins>Window Nucleus</ins></i>）的周围都环绕着一个Web驱动、无限维的窗口对象世界, 这个场景使得窗口核可以媲美宇宙之中巨大星系的星系核, 由于桌面软件领域缺乏类似哈勃、Webb这类的“天文望远镜”，这个局部无限维环绕世界一直隐藏在开发者的视线之外，如同地心说时代人类所看到的宇宙一样，我们的祖先在地心说阶段只能看到有限个数的星体，不知道河外星系的存在。</p>
<center>
