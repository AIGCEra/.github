...
<h2>
You don't know the true face of a mountain, just because you live in this mountain(不识庐山真面目，只缘身在此山中). Every Desktop Software hides a Cosmic-Scale Infinite Hierarchy Structure, WebRuntime provides a <i>Concise</i> and <i>Universal</i> Technical Solution to activate this Structure. In fact, this is a <i>blind spot</i> that has been neglected by developers for a long time, it's time to reveal what it really is...
</h2>
