...
Copy all files included with [***DotNetPlus***](https://github.com/TangramDev/WebRTSDK/tree/main/MFCPlus) into the prepared WinForm Project,</p> Reference “cosmos.dll”, adjust manifest and compilation configurations</h3>
