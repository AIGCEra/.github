        ...
        <table border="3" cellpadding="3">
            <thead>
                <tr>
                    ...
                    <th> <strong>Precompiled Header File, Mainfest Files and DPI</strong>
               </tr>            
	<tbody>
                <tr>
                    <td width="33%">
