...
| <div align=center>__Desktop Application System Runtime <br>Instance State__</div> |<div align=center>WebRuntime allows an executable file to have any number of "__Runtime Instance States__", <br>which is significantly different from traditional development techniques. Each "__Runtime Instance State__" <br>depends on a local folder, and within each such folder contains a configuration file, an initialization <br>Web page and subfolders closely related to the runtime state, data files, and a necessary component of the application system. Different Runtime States have completely different runtime structures, similar to a <br>Second-Order Partial Differential Equation, we know that every Second-Order Partial Differential Equation <br>with clear physical meaning (such as the famous wave equation), Its initial value conditions and boundary conditions determine the physical meaning of the solution of this equation. The description of each __Desktop Application Runtime Instance State__ may determine the structure of a software universe, and the differences between different states can be interpreted as Different Parallel Universes._</div>|  
</div>
<hr />
