...
[OpenWebRuntime](https://github.com/TangramDev/OpenWebRunTime) can work synchronously with the <i>Latest Version Chromium Project</i>([Canary, Dev, Beta, and Stable Version](https://github.com/TangramDev/.github/blob/main/document/WorkingwithChromiumSourceCode.md)) Source Code, to do this, you need to refer to the 
<div align=center>
