...
## When the Desktop Software Project created by the developer with Visual Studio Wizard can fully assume the role of the Browser Process of Chromium Project, then the developer first gets all the Web browsing functions that a Modern Web Browser should have, and it already has a complete Browser Window UI system, you can use it to browse the Web. Since the Desktop Software itself also has its own functional system and UI Mechanism, this new Browser Process should be able to support application-oriented Web pages, as shown in the following figure:<br><br><div align=center id="WebRuntime2"><img src="https://user-images.githubusercontent.com/26355688/180951488-6044fa9f-e816-4526-acd1-a28cb3aa71dd.jpg" width="100%" /></div><br>We hope that the new Browser Process can bring the Web Page Mechanism based on the Host Application Object Model to the Application, if this vision can be realized, then Web pages will become more important to specific desktop applications, and a Web Application Ecological Mechanism will naturally be formed.<br><br>The Web Runtime provides developers with a "_Simplest Technical Strategy_" to convert "existing" or "newly created" _Desktop Software Projects_ into "_Browser Processes_" of "Chromium Project", it will completely eliminate the gap between _the Desktop Software_ and _Web Browser_ and makes Web Technology an inherent part of _Desktop Software Architecture_: <br><br><div align=center><div align=center>__[WinForm](https://github.com/TangramDev/.github/blob/main/document/winformdev.md)__&emsp;&emsp;__[MFC](https://github.com/TangramDev/.github/blob/main/document/mfcexe.md)__</div><div align=right>[More Information ...](https://github.com/TangramDev/.github/blob/main/document/TechnicalStrategy.md)</div>
<hr />
