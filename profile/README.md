...
<center>
        <table border="3" cellpadding="3">
            ...
            <tbody>
		     ...
		     <strong><p>AppBase: Replace "public CWinApp(Ex)" with "public CWebRTApp(Ex)"</p><p>MDIFrameBase: Replace "public CMDIFrameWndEx" with "public CWebRTMDIFrame"</p></strong>
                    </td>
            </tbody>
	    <tbody>
                <tr>
