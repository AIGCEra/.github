...
Copy all files included with [***DotNetPlus***](https://github.com/TangramDev/WebRTSDK/tree/main/DotNetPlus) into the prepared WinForm Project,</p> Reference “cosmos.dll”, adjust manifest and compilation configurations</h3>
...
[**108.0.5318.1**](https://github.com/TangramDev/WebRT_M108/releases/download/m108/webrt_108.0.5318.1.7z)</p>			
		     </h3>
                    </td>
                    <td width="45%">
		        2022-09-24 05:30 Build, size: 90.64 MB
                    </td>
                <tr>
                    <td width="25%">
                        <h4 align=center>
